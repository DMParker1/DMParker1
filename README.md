...
*Connecting stories from the field with data from space to understand disease and society.*
...
- Selected highlight: **Dire Dawa sero-epidemiology analysis** → [https://github.com/parker-group/DireDawa_Seroepi](https://github.com/parker-group/DireDawa_Seroepi)
